...
public class UserRating {
	...
	public void initData(String userId, ContainerMetaDataService containerMetaDataService) {
        this.setUserId(userId);
        this.setRatings(Arrays.asList(
                new Rating("100", 3),
                new Rating("200", 4)
        ));
        this.setContainerMetaDataServiceInfo(containerMetaDataService.retrieveContainerMetadataInfo());
    }
}
